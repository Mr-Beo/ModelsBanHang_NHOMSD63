...
using BlazorKhachHang.ViewModel;
...
builder.Services.AddScoped<CartState>(); // thêm hiển thị  giỏ hàng 
builder.Services.AddScoped<FavoriteState>(); // thêm hiển thị sản phẩm yêu thích
