    ...
    public class TaiKhoansController : ControllerBase
    {
        ...
        public async Task<ActionResult<LoginResponseDto>> Login(string username, string pass)
        {
            ...
            if (userChucVu != null)
            {
                ...
                if (userChucVu.NhanVien != null &&
                    userChucVu.NhanVien.TrangThai == false)
                {
                ...
                string role = _chucVuRepository
                    .GetByIdChucVuAsync(
                        _nhanVienRepository
                        .GetIdNhanVienTaiKhoan(userChucVu.TaikhoanId)
                        .Result.ChucVuId.Value
                    ).Result.TenChucVu;
        ...
        public async Task<ActionResult<LoginResponseDto>> LoginKH(string username, string pass)
        {
            ...
            if (userChucVu != null)
            {
                return Ok(new LoginResponseDto
                {
                    ...
                    IsSuccess = true,
                    Username = username,
                    HoTen = userChucVu.KhachHang.HoTen,
                    Email = userChucVu.KhachHang.Email,
                    SoDienThoai = userChucVu.KhachHang.SoDienThoai,
                    Message = "Đăng nhập thành công!"
                });
            }
            else
