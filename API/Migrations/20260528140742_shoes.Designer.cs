...
namespace API.Migrations
{
    ...
    [Migration("20260528140742_shoes")]
    partial class shoes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Models.TraHang", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("GiaTaiThoiDiemTra")
            ...
            modelBuilder.Entity("Data.Models.HoaDon", b =>
                {
                    ...
                    b.Property<DateTime?>("ChoGiaoHang")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("DangGiao")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Data.Models.KichCo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            KichCoId = new Guid("5e70d190-8faf-41d2-98a4-5ed8ff801655"),
                            MoTa = "Cỡ giày 35",
                            TenKichCo = "Size 35",
                            TrangThai = true,
                            size = 35
                        ...
                        new
                        {
                            KichCoId = new Guid("637e965f-a43c-4e5e-a5f7-5717165072ba"),
                            MoTa = "Cỡ giày 36",
                            TenKichCo = "Size 36",
                            TrangThai = true,
                            size = 36
                        ...
                        new
                        {
                            KichCoId = new Guid("12ea5fec-c290-4ff6-9f80-e315facbf56d"),
                            MoTa = "Cỡ giày 37",
                            TenKichCo = "Size 37",
                            TrangThai = true,
                            size = 37
                        ...
                        new
                        {
                            KichCoId = new Guid("9e45ad49-3252-4a66-be12-99db22876bc4"),
                            MoTa = "Cỡ giày 38",
                            TenKichCo = "Size 38",
                            TrangThai = true,
                            size = 38
                        ...
                        new
                        {
                            KichCoId = new Guid("65cdee82-480b-4d9c-b0f5-e8240f265718"),
                            MoTa = "Cỡ giày 39",
                            TenKichCo = "Size 39",
                            TrangThai = true,
                            size = 39
                        ...
                        new
                        {
                            KichCoId = new Guid("7c2ae2e7-f0f5-477d-8581-a5719dd2beac"),
                            MoTa = "Cỡ giày 40",
                            TenKichCo = "Size 40",
                            TrangThai = true,
                            size = 40
                        ...
                        new
                        {
                            KichCoId = new Guid("88ae3680-ec91-4685-9a70-aed66ccab464"),
                            MoTa = "Cỡ giày 41",
                            TenKichCo = "Size 41",
                            TrangThai = true,
                            size = 41
                        ...
                        new
                        {
                            KichCoId = new Guid("6fc2e78f-fcbd-45db-aa26-fc58cdded31b"),
                            MoTa = "Cỡ giày 42",
                            TenKichCo = "Size 42",
                            TrangThai = true,
                            size = 42
                        ...
                        new
                        {
                            KichCoId = new Guid("1a73e715-1558-4df0-a3c2-7ba3d930db94"),
                            MoTa = "Cỡ giày 43",
                            TenKichCo = "Size 43",
                            TrangThai = true,
                            size = 43
                        ...
                        new
                        {
                            KichCoId = new Guid("0c11bbb7-4ff6-4bb4-a1d6-8927b212c31e"),
                            MoTa = "Cỡ giày 44",
                            TenKichCo = "Size 44",
                            TrangThai = true,
                            size = 44
                        ...
                        new
                        {
                            KichCoId = new Guid("fd30b205-fb42-4e7b-88a7-ec40b5e48db2"),
                            MoTa = "Cỡ giày 45",
                            TenKichCo = "Size 45",
                            TrangThai = true,
                            size = 45
                        ...
                        new
                        {
                            KichCoId = new Guid("748c63b2-44ec-4efd-8bba-c2a111e6a313"),
                            MoTa = "Cỡ giày 46",
                            TenKichCo = "Size 46",
                            TrangThai = true,
                            size = 46
                        ...
                        new
                        {
                            KichCoId = new Guid("c254f28b-9431-4c16-8c7a-76e5d243b335"),
                            MoTa = "Cỡ giày 47",
                            TenKichCo = "Size 47",
                            TrangThai = true,
                            size = 47
                        ...
                        new
                        {
                            KichCoId = new Guid("9c341a3c-d65f-4a98-ba17-7258ee710f1d"),
                            MoTa = "Cỡ giày 48",
                            TenKichCo = "Size 48",
                            TrangThai = true,
                            size = 48
                        ...
                        new
                        {
                            KichCoId = new Guid("98011fc8-3db5-4977-a9cf-81fc305d6dff"),
                            MoTa = "Cỡ giày 49",
                            TenKichCo = "Size 49",
                            TrangThai = true,
                            size = 49
                        ...
                        new
                        {
                            KichCoId = new Guid("58adc2f0-4a33-40df-8548-eb98977fc073"),
                            MoTa = "Cỡ giày 50",
                            TenKichCo = "Size 50",
                            TrangThai = true,
                            size = 50
            ...
            modelBuilder.Entity("Data.Models.MauSac", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MauSacId = new Guid("9d658b78-b28b-4864-9ca7-72f7ff64c832"),
                            Color = "#FF0000",
                            MoTa = "Màu đỏ cơ bản",
                            TenMau = "Đỏ",
                            TrangThai = true
                        ...
                        new
                        {
                            MauSacId = new Guid("d0e17b4d-e76c-4646-8237-8619561f9f08"),
                            Color = "#0000FF",
                        ...
                        new
                        {
                            MauSacId = new Guid("db9517db-d220-4a4a-8019-768bc29fa60b"),
                            Color = "#00FF00",
                        ...
                        new
                        {
                            MauSacId = new Guid("c9a0568a-e87a-4159-9758-794ce71cb6d0"),
                            Color = "#FFFF00",
                            MoTa = "Màu vàng",
                            TenMau = "Vàng",
                            TrangThai = true
                        ...
                        new
                        {
                            MauSacId = new Guid("58c0bdc1-863b-47a2-98fb-b4404af8234a"),
                            Color = "#000000",
                            MoTa = "Màu đen",
                            TenMau = "Đen",
                            TrangThai = true
                        ...
                        new
                        {
                            MauSacId = new Guid("bb6a29a7-5855-4449-8961-aaef7c9617d4"),
                            Color = "#FFFFFF",
                            MoTa = "Màu trắng",
                            TenMau = "Trắng",
                            TrangThai = true
            ...
            modelBuilder.Entity("Data.Models.NhanVien", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NgayCapNhatCuoiCung = new DateTime(2026, 5, 28, 21, 7, 42, 281, DateTimeKind.Local).AddTicks(4055),
            ...
            modelBuilder.Entity("Data.Models.TaiKhoan", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            TaikhoanId = new Guid("99999999-9999-9999-9999-999999999999"),
                            Ngaytaotaikhoan = new DateTime(2026, 5, 28, 21, 7, 42, 281, DateTimeKind.Local).AddTicks(3986),
                            Password = "admin123",
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("API.Models.TraHang", b =>
                {
                    ...
                    b.HasOne("Data.Models.HoaDon", "HoaDon")
                        .WithMany()
