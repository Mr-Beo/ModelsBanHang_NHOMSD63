        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TGXacNhan = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ChoGiaoHang = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DangGiao = table.Column<DateTime>(type: "datetime2", nullable: true),
                    HoanThanh = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GiayChiTietId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SoLuong = table.Column<int>(type: "int", nullable: false),
                    GiaTaiThoiDiemTra = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TraHangs_GiayChiTiets_GiayChiTietId",
                        column: x => x.GiayChiTietId,
                        principalTable: "GiayChiTiets",
                        principalColumn: "GiayChiTietId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TraHangs_HoaDons_HoaDonId",
                        column: x => x.HoaDonId,
                        principalTable: "HoaDons",
                        principalColumn: "HoaDonId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0c11bbb7-4ff6-4bb4-a1d6-8927b212c31e"), "Cỡ giày 44", "Size 44", true, 44 },
                    { new Guid("12ea5fec-c290-4ff6-9f80-e315facbf56d"), "Cỡ giày 37", "Size 37", true, 37 },
                    { new Guid("1a73e715-1558-4df0-a3c2-7ba3d930db94"), "Cỡ giày 43", "Size 43", true, 43 },
                    { new Guid("58adc2f0-4a33-40df-8548-eb98977fc073"), "Cỡ giày 50", "Size 50", true, 50 },
                    { new Guid("5e70d190-8faf-41d2-98a4-5ed8ff801655"), "Cỡ giày 35", "Size 35", true, 35 },
                    { new Guid("637e965f-a43c-4e5e-a5f7-5717165072ba"), "Cỡ giày 36", "Size 36", true, 36 },
                    { new Guid("65cdee82-480b-4d9c-b0f5-e8240f265718"), "Cỡ giày 39", "Size 39", true, 39 },
                    { new Guid("6fc2e78f-fcbd-45db-aa26-fc58cdded31b"), "Cỡ giày 42", "Size 42", true, 42 },
                    { new Guid("748c63b2-44ec-4efd-8bba-c2a111e6a313"), "Cỡ giày 46", "Size 46", true, 46 },
                    { new Guid("7c2ae2e7-f0f5-477d-8581-a5719dd2beac"), "Cỡ giày 40", "Size 40", true, 40 },
                    { new Guid("88ae3680-ec91-4685-9a70-aed66ccab464"), "Cỡ giày 41", "Size 41", true, 41 },
                    { new Guid("98011fc8-3db5-4977-a9cf-81fc305d6dff"), "Cỡ giày 49", "Size 49", true, 49 },
                    { new Guid("9c341a3c-d65f-4a98-ba17-7258ee710f1d"), "Cỡ giày 48", "Size 48", true, 48 },
                    { new Guid("9e45ad49-3252-4a66-be12-99db22876bc4"), "Cỡ giày 38", "Size 38", true, 38 },
                    { new Guid("c254f28b-9431-4c16-8c7a-76e5d243b335"), "Cỡ giày 47", "Size 47", true, 47 },
                    { new Guid("fd30b205-fb42-4e7b-88a7-ec40b5e48db2"), "Cỡ giày 45", "Size 45", true, 45 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("58c0bdc1-863b-47a2-98fb-b4404af8234a"), "#000000", "Màu đen", "Đen", true },
                    { new Guid("9d658b78-b28b-4864-9ca7-72f7ff64c832"), "#FF0000", "Màu đỏ cơ bản", "Đỏ", true },
                    { new Guid("bb6a29a7-5855-4449-8961-aaef7c9617d4"), "#FFFFFF", "Màu trắng", "Trắng", true },
                    { new Guid("c9a0568a-e87a-4159-9758-794ce71cb6d0"), "#FFFF00", "Màu vàng", "Vàng", true },
                    { new Guid("d0e17b4d-e76c-4646-8237-8619561f9f08"), "#0000FF", "Màu xanh dương cơ bản", "Xanh dương", true },
                    { new Guid("db9517db-d220-4a4a-8019-768bc29fa60b"), "#00FF00", "Màu xanh lá cây", "Xanh lá", true }
                });

            migrationBuilder.InsertData(
                table: "TaiKhoans",
                columns: new[] { "TaikhoanId", "Ngaytaotaikhoan", "Password", "Username" },
                values: new object[] { new Guid("99999999-9999-9999-9999-999999999999"), new DateTime(2026, 5, 28, 21, 7, 42, 281, DateTimeKind.Local).AddTicks(3986), "admin123", "admin" });

            migrationBuilder.InsertData(
                table: "hinhThucThanhToans",
                columns: new[] { "HinhThucThanhToanId", "MoTa", "TenHinhThuc", "TrangThai" },
                values: new object[,]
                {
                    { new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), "Khách thanh toán khi nhận hàng", "Thanh toán khi nhận hàng (COD)", true },
                    { new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), "Thanh toán qua cổng VNPay", "Thanh toán VNPay", true }
                });

            migrationBuilder.InsertData(
                table: "NhanViens",
                columns: new[] { "NhanVienId", "ChucVuId", "Email", "HoTen", "NgayCapNhatCuoiCung", "NgaySinh", "SoDienThoai", "TaikhoanId", "TrangThai" },
                values: new object[] { new Guid("88888888-8888-8888-8888-888888888888"), new Guid("11111111-1111-1111-1111-111111111111"), "admin@shop.com", "Nguyễn Văn Quản Trị", new DateTime(2026, 5, 28, 21, 7, 42, 281, DateTimeKind.Local).AddTicks(4055), new DateTime(1995, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "0987654321", new Guid("99999999-9999-9999-9999-999999999999"), true });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TraHangs_GiayChiTietId",
                table: "TraHangs",
                column: "GiayChiTietId");

            migrationBuilder.CreateIndex(
                name: "IX_TraHangs_HoaDonId",
                table: "TraHangs",
                column: "HoaDonId");
        }
